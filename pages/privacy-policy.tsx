...
const PrivacyPolicy: NextPage = () => {
  return (
    <>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to LATAM Argentina Virtual.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to LATAM Argentina Virtual,
            accessible from{" "}
            <a
              href="https://latamva.com.ar"
              rel="external nofollow noopener noreferrer"
              target="_blank"
            >
              https://latamva.com.ar
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: contacto@latamva.com.ar</li>
      </ul>
    </>
  );
};
